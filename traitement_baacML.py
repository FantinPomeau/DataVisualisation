...
cntr_dep = gpd.read_file("C:\\Users\\fanti\\OneDrive\\Documents\\Actuariat\\M2\\data viz\\departements.geojson")
cntr_dep.rename(columns = {"code" : "dep", "nom":"Nom_dep","geometry":"geometry_dep"}, inplace = True)

cntr_com_2021 = gpd.read_file(r"C:\Users\fanti\OneDrive\Documents\Actuariat\M2\data viz\commune-frmetdrom-2021\commune-frmetdrom-2021\COMMUNE_FRMETDROM.shp")
